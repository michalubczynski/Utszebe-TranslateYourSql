...
namespace API.Controllers
{
    public class QueryController : BaseController
    {
        ...
        private readonly IQuerGeneratorAIModel _querGeneratorAIModel;
        private readonly IHubContext<ResultHub> _hubContext;
        private readonly ITranslator _translator;


        public QueryController(IDatabaseRepository database, IQuerGeneratorAIModel messageTranslator, IHubContext<ResultHub> hubContext, ITranslator translator)
        {
            _database = database;
            _querGeneratorAIModel = messageTranslator;
        ...
        public async Task<ActionResult<string[]>> GetResult([FromBody] Message request)
        {
            ...
            var fullResultFromAi = await _querGeneratorAIModel.GenerateResponse(promptString, UpdateRespopnse);
